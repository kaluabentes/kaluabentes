...
const HomeHero = () => (
  <Hero
    ...
    paragraph="Desenvolvedor Frontend JAMStack, estudante de UI/UX e entusiasta de jogos HTML5. Minha missão é entregar telas de alta fidelidade, eficazes, acessíveis, perfomáticas e com um código escalável."
